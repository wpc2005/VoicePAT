...
enum [[deprecated]] : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 928,
    ...
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 930,
    ...
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 932,
    SBK_QLOCALE_IDX                                          = 380,
    ...
    SBK_QPROCESS_UNIXPROCESSFLAG_IDX                         = 502,
    SBK_QFLAGS_QPROCESS_UNIXPROCESSFLAG_IDX                  = 252,
    SBK_QPROCESS_IDX                                         = 488,
    SBK_QPROCESS_UNIXPROCESSPARAMETERS_IDX                   = 504,
    ...
    SBK_QREADLOCKER_IDX                                      = 516,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 520,
    SBK_QREADWRITELOCK_IDX                                   = 518,
    SBK_QRECT_IDX                                            = 522,
    SBK_QRECTF_IDX                                           = 524,
    SBK_QRECURSIVEMUTEX_IDX                                  = 526,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 534,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 256,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 532,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 530,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 254,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 536,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 258,
    SBK_QREGULAREXPRESSION_IDX                               = 528,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 538,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 540,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 544,
    SBK_QRESOURCE_IDX                                        = 542,
    SBK_QRUNNABLE_IDX                                        = 546,
    SBK_QSAVEFILE_IDX                                        = 548,
    SBK_QSEMAPHORE_IDX                                       = 550,
    SBK_QSEMAPHORERELEASER_IDX                               = 552,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 554,
    SBK_QSETTINGS_STATUS_IDX                                 = 562,
    SBK_QSETTINGS_FORMAT_IDX                                 = 558,
    SBK_QSETTINGS_SCOPE_IDX                                  = 560,
    SBK_QSETTINGS_IDX                                        = 556,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 566,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 568,
    SBK_QSHAREDMEMORY_IDX                                    = 564,
    SBK_QSIGNALBLOCKER_IDX                                   = 570,
    SBK_QSIGNALMAPPER_IDX                                    = 572,
    SBK_QSIZE_IDX                                            = 574,
    SBK_QSIZEF_IDX                                           = 576,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 578,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 582,
    SBK_QSOCKETNOTIFIER_IDX                                  = 580,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 584,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 590,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 588,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 260,
    SBK_QSTANDARDPATHS_IDX                                   = 586,
    SBK_QSTORAGEINFO_IDX                                     = 592,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 596,
    SBK_QSTRINGCONVERTER_IDX                                 = 594,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 600,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 262,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 598,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 602,
    SBK_QSTRINGDECODER_IDX                                   = 604,
    SBK_QSTRINGENCODER_IDX                                   = 606,
    SBK_QSTRINGLISTMODEL_IDX                                 = 608,
    SBK_QSYSINFO_SIZES_IDX                                   = 614,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 612,
    SBK_QSYSINFO_IDX                                         = 610,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 618,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 620,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 616,
    SBK_QTEMPORARYDIR_IDX                                    = 622,
    SBK_QTEMPORARYFILE_IDX                                   = 624,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 630,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 628,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 264,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 626,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 638,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 634,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 640,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 636,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 266,
    SBK_QTEXTSTREAM_IDX                                      = 632,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 642,
    SBK_QTHREAD_PRIORITY_IDX                                 = 646,
    SBK_QTHREAD_QUALITYOFSERVICE_IDX                         = 648,
    SBK_QTHREAD_IDX                                          = 644,
    SBK_QTHREADPOOL_IDX                                      = 650,
    SBK_QTIME_IDX                                            = 652,
    SBK_QTIMELINE_STATE_IDX                                  = 658,
    SBK_QTIMELINE_DIRECTION_IDX                              = 656,
    SBK_QTIMELINE_IDX                                        = 654,
    SBK_QTIMEZONE_INITIALIZATION_IDX                         = 662,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 668,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 664,
    SBK_QTIMEZONE_IDX                                        = 660,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 666,
    SBK_QTIMER_IDX                                           = 670,
    SBK_QTIMEREVENT_IDX                                      = 672,
    SBK_QTRANSLATOR_IDX                                      = 674,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 676,
    SBK_QURL_PARSINGMODE_IDX                                 = 684,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 686,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 682,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 270,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 688,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 274,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 680,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 268,
    SBK_QURL_IDX                                             = 678,
    SBK_QURLQUERY_IDX                                        = 690,
    SBK_QUUID_VARIANT_IDX                                    = 696,
    SBK_QUUID_VERSION_IDX                                    = 698,
    SBK_QUUID_STRINGFORMAT_IDX                               = 694,
    SBK_QUUID_IDX                                            = 692,
    SBK_QVARIANTANIMATION_IDX                                = 700,
    SBK_QVERSIONNUMBER_IDX                                   = 702,
    SBK_QWAITCONDITION_IDX                                   = 704,
    SBK_QWRITELOCKER_IDX                                     = 706,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 708,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 710,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 712,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 714,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 716,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 718,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 726,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 724,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 722,
    SBK_QXMLSTREAMREADER_IDX                                 = 720,
    SBK_QXMLSTREAMWRITER_IDX                                 = 728,
    SBK_QT_GLOBALCOLOR_IDX                                   = 802,
    SBK_QT_COLORSCHEME_IDX                                   = 758,
    SBK_QT_MOUSEBUTTON_IDX                                   = 834,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 302,
    SBK_QT_ORIENTATION_IDX                                   = 844,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 306,
    SBK_QT_FOCUSPOLICY_IDX                                   = 792,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 872,
    SBK_QT_SORTORDER_IDX                                     = 868,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 870,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 310,
    SBK_QT_TILERULE_IDX                                      = 882,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 732,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 276,
    SBK_QT_TEXTFLAG_IDX                                      = 876,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 874,
    SBK_QT_WHITESPACEMODE_IDX                                = 902,
    SBK_QT_HITTESTACCURACY_IDX                               = 806,
    SBK_QT_WINDOWTYPE_IDX                                    = 912,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 320,
    SBK_QT_WINDOWSTATE_IDX                                   = 910,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 318,
    SBK_QT_APPLICATIONSTATE_IDX                              = 738,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 278,
    SBK_QT_SCREENORIENTATION_IDX                             = 856,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 308,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 904,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 736,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 808,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 290,
    SBK_QT_BGMODE_IDX                                        = 746,
    SBK_QT_KEY_IDX                                           = 822,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 824,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 298,
    SBK_QT_MODIFIER_IDX                                      = 832,
    SBK_QT_ARROWTYPE_IDX                                     = 740,
    SBK_QT_PENSTYLE_IDX                                      = 850,
    SBK_QT_PENCAPSTYLE_IDX                                   = 846,
    SBK_QT_PENJOINSTYLE_IDX                                  = 848,
    SBK_QT_BRUSHSTYLE_IDX                                    = 748,
    SBK_QT_SIZEMODE_IDX                                      = 866,
    SBK_QT_UIEFFECT_IDX                                      = 900,
    SBK_QT_CURSORSHAPE_IDX                                   = 770,
    SBK_QT_TEXTFORMAT_IDX                                    = 878,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 742,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 776,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 280,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 778,
    SBK_QT_TOOLBARAREA_IDX                                   = 890,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 314,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 892,
    SBK_QT_DATEFORMAT_IDX                                    = 772,
    SBK_QT_TIMESPEC_IDX                                      = 884,
    SBK_QT_DAYOFWEEK_IDX                                     = 774,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 858,
    SBK_QT_CASESENSITIVITY_IDX                               = 750,
    SBK_QT_CORNER_IDX                                        = 768,
    SBK_QT_EDGE_IDX                                          = 782,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 284,
    SBK_QT_CONNECTIONTYPE_IDX                                = 760,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 862,
    SBK_QT_FILLRULE_IDX                                      = 788,
    SBK_QT_MASKMODE_IDX                                      = 828,
    SBK_QT_CLIPOPERATION_IDX                                 = 756,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 818,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 820,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 898,
    SBK_QT_AXIS_IDX                                          = 744,
    SBK_QT_FOCUSREASON_IDX                                   = 794,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 762,
    SBK_QT_CONTEXTMENUTRIGGER_IDX                            = 764,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 812,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 294,
    SBK_QT_INPUTMETHODHINT_IDX                               = 810,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 292,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 784,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 894,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 826,
    SBK_QT_ANCHORPOINT_IDX                                   = 734,
    SBK_QT_FINDCHILDOPTION_IDX                               = 790,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 286,
    SBK_QT_DROPACTION_IDX                                    = 780,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 282,
    SBK_QT_CHECKSTATE_IDX                                    = 752,
    SBK_QT_ITEMDATAROLE_IDX                                  = 814,
    SBK_QT_ITEMFLAG_IDX                                      = 816,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 296,
    SBK_QT_MATCHFLAG_IDX                                     = 830,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 300,
    SBK_QT_WINDOWMODALITY_IDX                                = 908,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 880,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 312,
    SBK_QT_EVENTPRIORITY_IDX                                 = 786,
    SBK_QT_SIZEHINT_IDX                                      = 864,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 906,
    SBK_QT_COORDINATESYSTEM_IDX                              = 766,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 896,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 316,
    SBK_QT_GESTURESTATE_IDX                                  = 798,
    SBK_QT_GESTURETYPE_IDX                                   = 800,
    SBK_QT_GESTUREFLAG_IDX                                   = 796,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 288,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 840,
    SBK_QT_NAVIGATIONMODE_IDX                                = 842,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 936,
    SBK_QT_TIMERTYPE_IDX                                     = 888,
    SBK_QT_TIMERID_IDX                                       = 886,
    SBK_QT_SCROLLPHASE_IDX                                   = 860,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 838,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 836,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 304,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 754,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 804,
    SBK_QT_PERMISSIONSTATUS_IDX                              = 852,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 854,
    SBK_QTCOREQT_IDX                                         = 730,
    SBK_QTCOREHELPER_QDIRLISTINGITERATOR_IDX                 = 916,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 918,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 920,
    SBK_QTCOREHELPER_QIOPIPE_IDX                             = 922,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 924,
    SBK_QCBORKNOWNTAGS_IDX                                   = 72,
    SBK_QCBORSIMPLETYPE_IDX                                  = 78,
    SBK_QCBORTAG_IDX                                         = 92,
    SBK_QTMSGTYPE_IDX                                        = 926,
    SBK_QTCORE_IDX_COUNT                                     = 938,
};
...
enum : int {
    ...
    SBK_QCoreApplication_ApplicationFlags_IDX                = 464,
    ...
    SBK_QLocale_CurrencySymbolFormat_IDX                     = 465,
    ...
    SBK_QLocale_QuotationStyle_IDX                           = 466,
    SBK_QLocale_IDX                                          = 190,
    ...
    SBK_QProcess_UnixProcessFlag_IDX                         = 251,
    SBK_QFlags_QProcess_UnixProcessFlag_IDX                  = 126,
    SBK_QProcess_IDX                                         = 244,
    SBK_QProcess_UnixProcessParameters_IDX                   = 252,
    ...
    SBK_QReadLocker_IDX                                      = 258,
    SBK_QReadWriteLock_RecursionMode_IDX                     = 260,
    SBK_QReadWriteLock_IDX                                   = 259,
    SBK_QRect_IDX                                            = 261,
    SBK_QRectF_IDX                                           = 262,
    SBK_QRecursiveMutex_IDX                                  = 263,
    SBK_QRegularExpression_PatternOption_IDX                 = 267,
    SBK_QFlags_QRegularExpression_PatternOption_IDX          = 128,
    SBK_QRegularExpression_MatchType_IDX                     = 266,
    SBK_QRegularExpression_MatchOption_IDX                   = 265,
    SBK_QFlags_QRegularExpression_MatchOption_IDX            = 127,
    SBK_QRegularExpression_WildcardConversionOption_IDX      = 268,
    SBK_QFlags_QRegularExpression_WildcardConversionOption_IDX = 129,
    SBK_QRegularExpression_IDX                               = 264,
    SBK_QRegularExpressionMatch_IDX                          = 269,
    SBK_QRegularExpressionMatchIterator_IDX                  = 270,
    SBK_QResource_Compression_IDX                            = 272,
    SBK_QResource_IDX                                        = 271,
    SBK_QRunnable_IDX                                        = 273,
    SBK_QSaveFile_IDX                                        = 274,
    SBK_QSemaphore_IDX                                       = 275,
    SBK_QSemaphoreReleaser_IDX                               = 276,
    SBK_QSequentialAnimationGroup_IDX                        = 277,
    SBK_QSettings_Status_IDX                                 = 281,
    SBK_QSettings_Format_IDX                                 = 279,
    SBK_QSettings_Scope_IDX                                  = 280,
    SBK_QSettings_IDX                                        = 278,
    SBK_QSharedMemory_AccessMode_IDX                         = 283,
    SBK_QSharedMemory_SharedMemoryError_IDX                  = 284,
    SBK_QSharedMemory_IDX                                    = 282,
    SBK_QSignalBlocker_IDX                                   = 285,
    SBK_QSignalMapper_IDX                                    = 286,
    SBK_QSize_IDX                                            = 287,
    SBK_QSizeF_IDX                                           = 288,
    SBK_QSocketDescriptor_IDX                                = 289,
    SBK_QSocketNotifier_Type_IDX                             = 291,
    SBK_QSocketNotifier_IDX                                  = 290,
    SBK_QSortFilterProxyModel_IDX                            = 292,
    SBK_QStandardPaths_StandardLocation_IDX                  = 295,
    SBK_QStandardPaths_LocateOption_IDX                      = 294,
    SBK_QFlags_QStandardPaths_LocateOption_IDX               = 130,
    SBK_QStandardPaths_IDX                                   = 293,
    SBK_QStorageInfo_IDX                                     = 296,
    SBK_QStringConverter_Encoding_IDX                        = 298,
    SBK_QStringConverter_IDX                                 = 297,
    SBK_QStringConverterBase_Flag_IDX                        = 300,
    SBK_QFlags_QStringConverterBase_Flag_IDX                 = 131,
    SBK_QStringConverterBase_IDX                             = 299,
    SBK_QStringConverterBase_State_IDX                       = 301,
    SBK_QStringDecoder_IDX                                   = 302,
    SBK_QStringEncoder_IDX                                   = 303,
    SBK_QStringListModel_IDX                                 = 304,
    SBK_QSysInfo_Sizes_IDX                                   = 307,
    SBK_QSysInfo_Endian_IDX                                  = 306,
    SBK_QSysInfo_IDX                                         = 305,
    SBK_QSystemSemaphore_AccessMode_IDX                      = 309,
    SBK_QSystemSemaphore_SystemSemaphoreError_IDX            = 310,
    SBK_QSystemSemaphore_IDX                                 = 308,
    SBK_QTemporaryDir_IDX                                    = 311,
    SBK_QTemporaryFile_IDX                                   = 312,
    SBK_QTextBoundaryFinder_BoundaryType_IDX                 = 315,
    SBK_QTextBoundaryFinder_BoundaryReason_IDX               = 314,
    SBK_QFlags_QTextBoundaryFinder_BoundaryReason_IDX        = 132,
    SBK_QTextBoundaryFinder_IDX                              = 313,
    SBK_QTextStream_RealNumberNotation_IDX                   = 319,
    SBK_QTextStream_FieldAlignment_IDX                       = 317,
    SBK_QTextStream_Status_IDX                               = 320,
    SBK_QTextStream_NumberFlag_IDX                           = 318,
    SBK_QFlags_QTextStream_NumberFlag_IDX                    = 133,
    SBK_QTextStream_IDX                                      = 316,
    SBK_QTextStreamManipulator_IDX                           = 321,
    SBK_QThread_Priority_IDX                                 = 323,
    SBK_QThread_QualityOfService_IDX                         = 324,
    SBK_QThread_IDX                                          = 322,
    SBK_QThreadPool_IDX                                      = 325,
    SBK_QTime_IDX                                            = 326,
    SBK_QTimeLine_State_IDX                                  = 329,
    SBK_QTimeLine_Direction_IDX                              = 328,
    SBK_QTimeLine_IDX                                        = 327,
    SBK_QTimeZone_Initialization_IDX                         = 331,
    SBK_QTimeZone_TimeType_IDX                               = 334,
    SBK_QTimeZone_NameType_IDX                               = 332,
    SBK_QTimeZone_IDX                                        = 330,
    SBK_QTimeZone_OffsetData_IDX                             = 333,
    SBK_QTimer_IDX                                           = 335,
    SBK_QTimerEvent_IDX                                      = 336,
    SBK_QTranslator_IDX                                      = 337,
    SBK_QTransposeProxyModel_IDX                             = 338,
    SBK_QUrl_ParsingMode_IDX                                 = 342,
    SBK_QUrl_UrlFormattingOption_IDX                         = 343,
    SBK_QUrl_ComponentFormattingOption_IDX                   = 341,
    SBK_QFlags_QUrl_ComponentFormattingOption_IDX            = 135,
    SBK_QUrl_UserInputResolutionOption_IDX                   = 344,
    SBK_QFlags_QUrl_UserInputResolutionOption_IDX            = 137,
    SBK_QUrl_AceProcessingOption_IDX                         = 340,
    SBK_QFlags_QUrl_AceProcessingOption_IDX                  = 134,
    SBK_QUrl_IDX                                             = 339,
    SBK_QUrlQuery_IDX                                        = 345,
    SBK_QUuid_Variant_IDX                                    = 348,
    SBK_QUuid_Version_IDX                                    = 349,
    SBK_QUuid_StringFormat_IDX                               = 347,
    SBK_QUuid_IDX                                            = 346,
    SBK_QVariantAnimation_IDX                                = 350,
    SBK_QVersionNumber_IDX                                   = 351,
    SBK_QWaitCondition_IDX                                   = 352,
    SBK_QWriteLocker_IDX                                     = 353,
    SBK_QXmlStreamAttribute_IDX                              = 354,
    SBK_QXmlStreamAttributes_IDX                             = 355,
    SBK_QXmlStreamEntityDeclaration_IDX                      = 356,
    SBK_QXmlStreamEntityResolver_IDX                         = 357,
    SBK_QXmlStreamNamespaceDeclaration_IDX                   = 358,
    SBK_QXmlStreamNotationDeclaration_IDX                    = 359,
    SBK_QXmlStreamReader_TokenType_IDX                       = 363,
    SBK_QXmlStreamReader_ReadElementTextBehaviour_IDX        = 362,
    SBK_QXmlStreamReader_Error_IDX                           = 361,
    SBK_QXmlStreamReader_IDX                                 = 360,
    SBK_QXmlStreamWriter_IDX                                 = 364,
    SBK_Qt_GlobalColor_IDX                                   = 401,
    SBK_Qt_ColorScheme_IDX                                   = 379,
    SBK_Qt_MouseButton_IDX                                   = 417,
    SBK_QFlags_Qt_MouseButton_IDX                            = 151,
    SBK_Qt_Orientation_IDX                                   = 422,
    SBK_QFlags_Qt_Orientation_IDX                            = 153,
    SBK_Qt_FocusPolicy_IDX                                   = 396,
    SBK_Qt_TabFocusBehavior_IDX                              = 436,
    SBK_Qt_SortOrder_IDX                                     = 434,
    SBK_Qt_SplitBehaviorFlags_IDX                            = 435,
    SBK_QFlags_Qt_SplitBehaviorFlags_IDX                     = 155,
    SBK_Qt_TileRule_IDX                                      = 441,
    SBK_Qt_AlignmentFlag_IDX                                 = 366,
    SBK_QFlags_Qt_AlignmentFlag_IDX                          = 138,
    SBK_Qt_TextFlag_IDX                                      = 438,
    SBK_Qt_TextElideMode_IDX                                 = 437,
    SBK_Qt_WhiteSpaceMode_IDX                                = 451,
    SBK_Qt_HitTestAccuracy_IDX                               = 403,
    SBK_Qt_WindowType_IDX                                    = 456,
    SBK_QFlags_Qt_WindowType_IDX                             = 160,
    SBK_Qt_WindowState_IDX                                   = 455,
    SBK_QFlags_Qt_WindowState_IDX                            = 159,
    SBK_Qt_ApplicationState_IDX                              = 369,
    SBK_QFlags_Qt_ApplicationState_IDX                       = 139,
    SBK_Qt_ScreenOrientation_IDX                             = 428,
    SBK_QFlags_Qt_ScreenOrientation_IDX                      = 154,
    SBK_Qt_WidgetAttribute_IDX                               = 452,
    SBK_Qt_ApplicationAttribute_IDX                          = 368,
    SBK_Qt_ImageConversionFlag_IDX                           = 404,
    SBK_QFlags_Qt_ImageConversionFlag_IDX                    = 145,
    SBK_Qt_BGMode_IDX                                        = 373,
    SBK_Qt_Key_IDX                                           = 411,
    SBK_Qt_KeyboardModifier_IDX                              = 412,
    SBK_QFlags_Qt_KeyboardModifier_IDX                       = 149,
    SBK_Qt_Modifier_IDX                                      = 416,
    SBK_Qt_ArrowType_IDX                                     = 370,
    SBK_Qt_PenStyle_IDX                                      = 425,
    SBK_Qt_PenCapStyle_IDX                                   = 423,
    SBK_Qt_PenJoinStyle_IDX                                  = 424,
    SBK_Qt_BrushStyle_IDX                                    = 374,
    SBK_Qt_SizeMode_IDX                                      = 433,
    SBK_Qt_UIEffect_IDX                                      = 450,
    SBK_Qt_CursorShape_IDX                                   = 385,
    SBK_Qt_TextFormat_IDX                                    = 439,
    SBK_Qt_AspectRatioMode_IDX                               = 371,
    SBK_Qt_DockWidgetArea_IDX                                = 388,
    SBK_QFlags_Qt_DockWidgetArea_IDX                         = 140,
    SBK_Qt_DockWidgetAreaSizes_IDX                           = 389,
    SBK_Qt_ToolBarArea_IDX                                   = 445,
    SBK_QFlags_Qt_ToolBarArea_IDX                            = 157,
    SBK_Qt_ToolBarAreaSizes_IDX                              = 446,
    SBK_Qt_DateFormat_IDX                                    = 386,
    SBK_Qt_TimeSpec_IDX                                      = 442,
    SBK_Qt_DayOfWeek_IDX                                     = 387,
    SBK_Qt_ScrollBarPolicy_IDX                               = 429,
    SBK_Qt_CaseSensitivity_IDX                               = 375,
    SBK_Qt_Corner_IDX                                        = 384,
    SBK_Qt_Edge_IDX                                          = 391,
    SBK_QFlags_Qt_Edge_IDX                                   = 142,
    SBK_Qt_ConnectionType_IDX                                = 380,
    SBK_Qt_ShortcutContext_IDX                               = 431,
    SBK_Qt_FillRule_IDX                                      = 394,
    SBK_Qt_MaskMode_IDX                                      = 414,
    SBK_Qt_ClipOperation_IDX                                 = 378,
    SBK_Qt_ItemSelectionMode_IDX                             = 409,
    SBK_Qt_ItemSelectionOperation_IDX                        = 410,
    SBK_Qt_TransformationMode_IDX                            = 449,
    SBK_Qt_Axis_IDX                                          = 372,
    SBK_Qt_FocusReason_IDX                                   = 397,
    SBK_Qt_ContextMenuPolicy_IDX                             = 381,
    SBK_Qt_ContextMenuTrigger_IDX                            = 382,
    SBK_Qt_InputMethodQuery_IDX                              = 406,
    SBK_QFlags_Qt_InputMethodQuery_IDX                       = 147,
    SBK_Qt_InputMethodHint_IDX                               = 405,
    SBK_QFlags_Qt_InputMethodHint_IDX                        = 146,
    SBK_Qt_EnterKeyType_IDX                                  = 392,
    SBK_Qt_ToolButtonStyle_IDX                               = 447,
    SBK_Qt_LayoutDirection_IDX                               = 413,
    SBK_Qt_AnchorPoint_IDX                                   = 367,
    SBK_Qt_FindChildOption_IDX                               = 395,
    SBK_QFlags_Qt_FindChildOption_IDX                        = 143,
    SBK_Qt_DropAction_IDX                                    = 390,
    SBK_QFlags_Qt_DropAction_IDX                             = 141,
    SBK_Qt_CheckState_IDX                                    = 376,
    SBK_Qt_ItemDataRole_IDX                                  = 407,
    SBK_Qt_ItemFlag_IDX                                      = 408,
    SBK_QFlags_Qt_ItemFlag_IDX                               = 148,
    SBK_Qt_MatchFlag_IDX                                     = 415,
    SBK_QFlags_Qt_MatchFlag_IDX                              = 150,
    SBK_Qt_WindowModality_IDX                                = 454,
    SBK_Qt_TextInteractionFlag_IDX                           = 440,
    SBK_QFlags_Qt_TextInteractionFlag_IDX                    = 156,
    SBK_Qt_EventPriority_IDX                                 = 393,
    SBK_Qt_SizeHint_IDX                                      = 432,
    SBK_Qt_WindowFrameSection_IDX                            = 453,
    SBK_Qt_CoordinateSystem_IDX                              = 383,
    SBK_Qt_TouchPointState_IDX                               = 448,
    SBK_QFlags_Qt_TouchPointState_IDX                        = 158,
    SBK_Qt_GestureState_IDX                                  = 399,
    SBK_Qt_GestureType_IDX                                   = 400,
    SBK_Qt_GestureFlag_IDX                                   = 398,
    SBK_QFlags_Qt_GestureFlag_IDX                            = 144,
    SBK_Qt_NativeGestureType_IDX                             = 420,
    SBK_Qt_NavigationMode_IDX                                = 421,
    SBK_Qt_CursorMoveStyle_IDX                               = 468,
    SBK_Qt_TimerType_IDX                                     = 444,
    SBK_Qt_TimerId_IDX                                       = 443,
    SBK_Qt_ScrollPhase_IDX                                   = 430,
    SBK_Qt_MouseEventSource_IDX                              = 419,
    SBK_Qt_MouseEventFlag_IDX                                = 418,
    SBK_QFlags_Qt_MouseEventFlag_IDX                         = 152,
    SBK_Qt_ChecksumType_IDX                                  = 377,
    SBK_Qt_HighDpiScaleFactorRoundingPolicy_IDX              = 402,
    SBK_Qt_PermissionStatus_IDX                              = 426,
    SBK_Qt_ReturnByValueConstant_IDX                         = 427,
    SBK_QtCoreQt_IDX                                         = 365,
    SBK_QtCoreHelper_QDirListingIterator_IDX                 = 458,
    SBK_QtCoreHelper_QGenericArgumentHolder_IDX              = 459,
    SBK_QtCoreHelper_QGenericReturnArgumentHolder_IDX        = 460,
    SBK_QtCoreHelper_QIOPipe_IDX                             = 461,
    SBK_QtCoreHelper_QMutexLocker_IDX                        = 462,
    SBK_QCborKnownTags_IDX                                   = 36,
    SBK_QCborSimpleType_IDX                                  = 39,
    SBK_QCborTag_IDX                                         = 46,
    SBK_QtMsgType_IDX                                        = 463,
    SBK_QtCore_IDX_COUNT                                     = 469,
};
