...
#define __GMP_CFLAGS "-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /mnt/VoicePAT/voicepat_env/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/gmp_1718980463540/work=/usr/local/src/conda/gmp-6.3.0 -fdebug-prefix-map=/mnt/VoicePAT/voicepat_env=/usr/local/src/conda-prefix"
