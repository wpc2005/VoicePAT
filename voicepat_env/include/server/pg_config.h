...
#define CONFIGURE_ARGS " '--prefix=/mnt/VoicePAT/voicepat_env' '--with-libraries=/mnt/VoicePAT/voicepat_env/lib' '--with-includes=/mnt/VoicePAT/voicepat_env/include' '--enable-thread-safety' '--with-gssapi' '--with-icu' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-openssl' '--with-uuid=e2fs' '--with-system-tzdata=/mnt/VoicePAT/voicepat_env/share/zoneinfo' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /mnt/VoicePAT/voicepat_env/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1743503885589/work=/usr/local/src/conda/postgresql-split-17.4 -fdebug-prefix-map=/mnt/VoicePAT/voicepat_env=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/mnt/VoicePAT/voicepat_env/lib -Wl,-rpath-link,/mnt/VoicePAT/voicepat_env/lib -L/mnt/VoicePAT/voicepat_env/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /mnt/VoicePAT/voicepat_env/include' 'CXX=x86_64-conda-linux-gnu-c++' 'CXXFLAGS=-fvisibility-inlines-hidden -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /mnt/VoicePAT/voicepat_env/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1743503885589/work=/usr/local/src/conda/postgresql-split-17.4 -fdebug-prefix-map=/mnt/VoicePAT/voicepat_env=/usr/local/src/conda-prefix' 'CPP=/home/conda/feedstock_root/build_artifacts/postgresql-split_1743503885589/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/mnt/VoicePAT/voicepat_env/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 17.4 on x86_64-conda-linux-gnu, compiled by x86_64-conda-linux-gnu-cc (conda-forge gcc 13.3.0-2) 13.3.0, 64-bit"
